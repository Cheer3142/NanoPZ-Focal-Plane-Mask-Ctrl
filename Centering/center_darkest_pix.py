...
if __name__ == '__main__':
    ...
    while True:
        ...
        if len(files)>1:
            ...
            contours, _ = cv2.findContours(mask_c,
            ...
            #img_rect = cv2.rectangle(mask_c, (xc-120, yc-120), (xc+120, yc+120), (0, 255, 255), 10)
            #cv2.imshow('Rectangle', img_rect)
            
            #img_contours = cv2.drawContours(mask_c, contours, -1, (0,255,255), 3)
            img_contours = cv2.circle(mask_c, (x0//2,y0//2), radius=0, color=(255, 255, 255), thickness=10)
