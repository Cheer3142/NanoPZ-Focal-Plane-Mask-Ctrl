...
if __name__ == '__main__':
    ...
    while True:
        ...
        if len(files)>1:
            ...
            interpolation = interpolate.interp1d(dist_binned_intensity,dist_bin,fill_value="extrapolate")
            ...
            ## save the display
            #fig.savefig(r'C:\Users\Optics Lab 2\Documents\Cheer\NanoPZ v0\Dump\A\Mask_pressure'+ str(loops)+'.png')
